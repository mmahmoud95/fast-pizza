    ...
    <div className="space-y-8 px-4 py-6">
      <div className="flex flex-wrap items-center justify-between gap-3">
        ...
        <div className="space-x-2">
          {priority && (
            <span className="rounded-full bg-red-600 px-2 py-1 font-semibold uppercase tracking-wider text-red-50">
              Priority
            </span>
          )}
          <span className="rounded-full bg-green-600 px-2 py-1 font-semibold uppercase tracking-wider text-green-50">
            {status} order
          </span>
        </div>
      </div>
